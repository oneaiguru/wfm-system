-- =============================================================================
-- 061_multi_site_operations_infrastructure_fixed.sql
-- Multi-Site Operations Infrastructure (Tasks 11-15) - Fixed Version
-- =============================================================================
-- Version: 1.1
-- Created: 2025-07-14
-- Purpose: Enterprise-scale multi-site management capabilities (Fixed Foreign Keys)
...
CREATE TABLE site_resource_pools (
    ...
    -- Pool management
    pool_manager_id INTEGER, -- Fixed to INTEGER
    deputy_manager_id INTEGER, -- Fixed to INTEGER
    ...
    FOREIGN KEY (pool_manager_id) REFERENCES agents(id) ON DELETE SET NULL,
    FOREIGN KEY (deputy_manager_id) REFERENCES agents(id) ON DELETE SET NULL
);
...
CREATE TABLE site_resource_pool_allocations (
    ...
    -- Approval workflow
    requested_by INTEGER NOT NULL, -- Fixed to INTEGER
    approved_by INTEGER, -- Fixed to INTEGER
...
CREATE TABLE cross_site_assignments (
    ...
    -- Assignment basics
    employee_id INTEGER NOT NULL, -- Fixed to INTEGER
    ...
    host_site_manager_id INTEGER, -- Fixed to INTEGER
    project_lead_id INTEGER, -- Fixed to INTEGER
    ...
    local_buddy_assigned_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE cross_site_assignment_tasks (
    ...
    reviewer_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE location_hierarchies (
    ...
    location_manager_id INTEGER, -- Fixed to INTEGER
    administrative_contact_id INTEGER, -- Fixed to INTEGER
    facilities_contact_id INTEGER, -- Fixed to INTEGER
    security_contact_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE location_relationships (
    ...
    established_by INTEGER, -- Fixed to INTEGER
    approved_by INTEGER, -- Fixed to INTEGER
    approval_date DATE,
...
CREATE TABLE site_communication_logs (
    ...
    initiator_id INTEGER NOT NULL, -- Fixed to INTEGER
    ...
    escalated_to_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE site_communication_responses (
    ...
    -- Response details
    responder_id INTEGER NOT NULL, -- Fixed to INTEGER
    ...
    assigned_to_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE global_optimization_cache (
    ...
    triggered_by_user_id INTEGER, -- Fixed to INTEGER
    ...
    deployed_by_id INTEGER, -- Fixed to INTEGER
...
CREATE TABLE optimization_cache_usage (
    ...
    -- Usage details
    used_by_user_id INTEGER, -- Fixed to INTEGER
