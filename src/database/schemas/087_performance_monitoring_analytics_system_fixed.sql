-- Schema 087: Performance Monitoring and Analytics System (FIXED VERSION)
...
-- ============================================================================
-- 10. INDEXES FOR OPTIMAL PERFORMANCE (Fixed syntax)
-- ============================================================================

-- Indexes for real-time data queries
CREATE INDEX idx_perf_realtime_timestamp 
    ON performance_realtime_data (measurement_timestamp);

CREATE INDEX idx_perf_realtime_employee 
    ON performance_realtime_data (employee_id, measurement_timestamp);

CREATE INDEX idx_perf_realtime_metric 
    ON performance_realtime_data (metric_id, measurement_timestamp);
...
CREATE INDEX idx_perf_realtime_dept_timestamp 
    ON performance_realtime_data (department_id, measurement_timestamp DESC);

CREATE INDEX idx_perf_realtime_tags 
    ON performance_realtime_data USING GIN (tags);

-- Indexes for historical analytics
CREATE INDEX idx_perf_historical_date 
    ON performance_historical_analytics (analysis_date, metric_id);

CREATE INDEX idx_perf_historical_employee 
    ON performance_historical_analytics (employee_id, analysis_date);
...
CREATE INDEX idx_perf_historical_metric_date 
    ON performance_historical_analytics (metric_id, analysis_date DESC);

-- Indexes for forecasting
CREATE INDEX idx_perf_forecast_date 
    ON performance_forecasts (forecast_date, model_id);

CREATE INDEX idx_perf_forecast_model_date 
    ON performance_forecasts (model_id, forecast_date);

CREATE INDEX idx_perf_forecast_employee_future 
...
-- ============================================================================
-- 12. FUNCTIONS FOR PERFORMANCE OPTIMIZATION
-- ============================================================================
...
-- ============================================================================
-- 13. SAMPLE DATA WITH RUSSIAN LOCALIZATION
-- ============================================================================
...
COMMENT ON TABLE performance_realtime_data IS 'Real-time performance measurements with comprehensive tracking';
...
1. Real-time Performance Monitoring
   - Live metric collection with proper indexing
...
Total Tables: 16 core tables + 3 views + 2 functions
Estimated Storage: Scalable architecture
Performance: Optimized with 15+ indexes
Verification: All syntax errors fixed, ready for deployment
